const translations = {
  en: {
    ...
    Errors: {
      ...
      maxPage: 'Define max page error',
      getWords: "Can't get words",
      APIProblem: 'Problems with API',
      settingProblems: 'Problems with saving setting to API',
      statisticsProblems: 'Problems with saving statistics to API',
      updateWord: "Can't update word",
      saveWord: "Can't save word",
    },
    LearnWords: {
      newWords: 'New words',
  ...
  ru: {
    ...
    Errors: {
      ...
      registrationError: 'Такой пользовательно уже существует',
      maxPage: 'Ошибка определения максимальной страницы',
      getWords: 'Невозможно получить слова',
      APIProblem: 'Проблема с API',
      settingProblems: 'Проблема с сохранением настроек на API',
      statisticsProblems: 'Проблема с сохранением статистики на API',
      updateWord: 'Невозможно обновить слово',
      saveWord: 'Невозможно сохранить слово',
    },
    LearnWords: {
