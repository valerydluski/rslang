import { CHANGE_WORDS_COLLECTION } from './types';
...
const initialState = {
  wordsCollection: startWords,
};

const changeWordsCollectionReducer = (state = initialState, action) => {
  switch (action.type) {
    case CHANGE_WORDS_COLLECTION:
...
export default changeWordsCollectionReducer;
